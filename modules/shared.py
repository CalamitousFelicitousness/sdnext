...
options_templates.update(options_section(('interrogate', "Interrogate"), {
    ...
    "interrogate_vlm_temperature": OptionInfo(0.5, "VLM: num beams", gr.Slider, {"minimum": 0, "maximum": 1.0, "step": 0.01, "visible": False}),
    "interrogate_vlm_top_k": OptionInfo(0, "VLM: top-k", gr.Slider, {"minimum": 0, "maximum": 99, "step": 1, "visible": False}),
    "interrogate_vlm_top_p": OptionInfo(0.9, "VLM: top-p", gr.Slider, {"minimum": 0, "maximum": 1.0, "step": 0.01, "visible": False}),
