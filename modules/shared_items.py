...
sdnq_quant_modes = ["int8", "uint8", "int6", "uint6", "cb6", "uint5", "cb5", "uint4", "cb4", "uint3", "cb3", "uint2", "cb2", "float8_e4m3fn", "float8_e3m4fn", "float6_e3m2fn", "float5_e2m2fn", "float4_e2m1fn", "float3_e1m1fn", "float2_e1m0fn", "int16", "uint16", "float16"]
