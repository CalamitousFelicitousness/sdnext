...
from modules.api import models, endpoints, script, helpers, server, generate, process, control, video, audio, docs, gpu
...
class Api:
    def __init__(self, app: FastAPI, queue_lock: Lock):
        ...
        self.audio = audio.APIAudio(queue_lock)
        # compatibility api
    ...
    def register(self):
        ...
        self.add_api_route("/sdapi/v1/audio", self.audio.post_audio, methods=["POST"], response_model=audio.ResAudio, tags=["Generation"])
        ...
        self.add_api_route("/sdapi/v1/audio/models", self.audio.get_audio_models, methods=["GET"], response_model=list[audio.ItemAudioModel], tags=["Enumerators"])
        ...
        self.add_api_route("/sdapi/v1/audio/file", self.audio.get_audio_file, methods=["GET"], tags=["Functional"])
        self.add_api_route("/sdapi/v1/audio-info", self.audio.get_audio_info, methods=["GET"], tags=["Functional"])
